package euro.tickets.web.rest.errors;

import euro.tickets.service.UsernameAlreadyUsedException;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(euro.tickets.service.EmailAlreadyUsedException ex, NativeWebRequest request) {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleInvalidPasswordException(euro.tickets.service.InvalidPasswordException ex, NativeWebRequest request) {
